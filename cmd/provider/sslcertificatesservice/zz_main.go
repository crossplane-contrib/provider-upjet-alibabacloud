...
func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for AlibabaCloud sslcertificatesservice").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-upjet-alibabacloud-sslcertificatesservice"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-upjet-alibabacloud-sslcertificatesservice",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_sslcertificatesservice(mgr, o), "Cannot setup AlibabaCloud sslcertificatesservice controllers")
