...
func (in *VPCEndpointServiceInitParameters) DeepCopyInto(out *VPCEndpointServiceInitParameters) {
	*out = *in
	...
	if in.SupportedRegionList != nil {
		in, out := &in.SupportedRegionList, &out.SupportedRegionList
...
func (in *VpcEndpointInitParameters) DeepCopyInto(out *VpcEndpointInitParameters) {
	*out = *in
	...
	if in.CrossRegionBandwidth != nil {
		in, out := &in.CrossRegionBandwidth, &out.CrossRegionBandwidth
		*out = new(float64)
		**out = **in
	}
	if in.DryRun != nil {
	...
	if in.ServiceRegionID != nil {
		in, out := &in.ServiceRegionID, &out.ServiceRegionID
		*out = new(string)
		**out = **in
	}
	if in.Tags != nil {
