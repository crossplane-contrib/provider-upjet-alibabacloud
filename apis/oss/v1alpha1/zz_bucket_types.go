...
type BucketInitParameters struct {
	...
	// The canned ACL to apply. Can be "private", "public-read" and "public-read-write". This property has been deprecated since 1.220.0, please use the resource alicloud_oss_bucket_acl instead.
	...
	// The configuration of referer. This property has been deprecated since 1.220.0, please use the resource alicloud_oss_bucket_referer instead. See referer_config below.
	RefererConfig []RefererConfigInitParameters `json:"refererConfig,omitempty" tf:"referer_config,omitempty"`
...
type BucketObservation struct {
	...
	// The configuration of referer. This property has been deprecated since 1.220.0, please use the resource alicloud_oss_bucket_referer instead. See referer_config below.
	RefererConfig []RefererConfigObservation `json:"refererConfig,omitempty" tf:"referer_config,omitempty"`
