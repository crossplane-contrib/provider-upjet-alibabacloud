...
func (tr *Store) GetObservation() (map[string]any, error) {
...
func (tr *Store) SetObservation(obs map[string]any) error {
...
func (tr *Store) GetParameters() (map[string]any, error) {
...
func (tr *Store) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Store
func (tr *Store) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Store
func (tr *Store) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
